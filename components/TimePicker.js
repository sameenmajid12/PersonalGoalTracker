    ...
    <View style={styles.pickerContainer}>
      <Picker
        ...
        onValueChange={(ItemValue) =>
          setTime((prev) => ({ ...prev, hours: ItemValue }))
        }
      >
      ...
      <Picker
        ...
        onValueChange={(ItemValue) =>
          setTime((prev) => ({ ...prev, minutes: ItemValue }))
        }
      >
      ...
      <Picker style={{flex:1}} selectedValue={time.AMPM} onValueChange={(ItemValue)=>setTime((prev)=>({...prev, AMPM:ItemValue}))}>
